...
export default function Signup() {
    ...
    const handleSignup = async (e) => {
        ...
        console.log(data);
        try {
            const response = await fetch(Config.link + "user/register", {
                method: "POST",
                headers: {
    ...
    const handleLogin = async (e) => {
        ...
        console.log(data);
        try {
            const response = await fetch(Config.link + "user/login", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
    ...
    return (
        ...
        <Card className="max-w-md mx-auto my-5 mt-9 bg-white rounded-xl shadow shadow-slate-300">
            <h1 className="text-4xl text-center font-bold text-slate-800 pt-3">Chat App</h1>
            <CardBody>
                <Tabs
                    fullWidth
                    size="lg"
                ...
                >
                    <Tab key="login" title="Login">
                        <div className="">
                            <Button onClick={() => {
                                window.open(Config.link + "auth/google", "_self")
                            }} startContent={
                                <img
